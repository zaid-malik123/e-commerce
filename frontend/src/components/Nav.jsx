  ...
  return (
    <div className="w-[100vw] h-[70px] bg-[#ecfafaec] z-[10] fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black">
      ...
      <div className="w-[30%] flex items-center justify-end gap-[20px]">
        ...
        <FaCartShopping className="w-[30px] h-[30px] text-[#000000] cursor-pointer hidden md:block" />
      ...
      {showSearch && (
        <div className="w-[100%] h-[80px] bg-[#d8f6f9dd] absolute top-[100%] top-0 right-0 flex items-center justify-center">
          <input
            ...
            className="md:w-[50%] w-[80%] h-[60%] bg-[#233533] rounded-[30px] px-[50px] placeholder:text-white text-[18px] text-white"
            type="text"
          />
        </div>
      )}
      ...
      <div className="w-[100vw] h-[90px] flex items-center justify-between px-[20px] fixed bottom-0 left-0 bg-[#191818] md:hidden text-[12px]">
        <button className="text-white flex items-center justify-center flex-col gap-[12px]">
          <IoMdHome size={27} className="text-white md:hidden" />
          Home
        </button>
        <button className="text-white flex items-center justify-center flex-col gap-[12px]">
          <BiSolidCollection size={27} className="text-white md:hidden" />
          Collections
        </button>
        <button className="text-white flex items-center justify-center flex-col gap-[12px]">
          <IoMdContacts size={27} className="text-white md:hidden" />
          Contact
        </button>
        <button className="text-white flex items-center justify-center flex-col gap-[12px]">
          <FaCartShopping size={27} className="text-white md:hidden" />
           Cart
        </button>
      </div>
    </div>
